<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SDM041.aspx.cs" Inherits="SdmSurvey.Surveys.SDM041" %>
...
<body>
                ...
                <section class="tiles">
                    <article class="style1">
                        <div>
                            ...
                            <p>我有心絞痛，需不需要接受心導管檢查/治療？</p>
                        </div>
                        <div>
                            <h3 style="font-size: 18pt; margin: 0px;">適用對象 / 適用狀況</h3>
                            <p>醫師臨床診斷為心絞痛，需要與您討論治療(檢查)的方式</p>
                        </div>
    ...
    <script>
        ...
        //reload
        var sq_grid = getParameterByName('id');
