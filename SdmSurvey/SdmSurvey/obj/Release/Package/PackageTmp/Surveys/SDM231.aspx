                    ...
                    <form method="post" action="javascript:;" id="cad_form" onsubmit="doSubmit()">
                        <article class="style1">
                            ...
                            <div class="ex" style="display: inline-block; position: relative; border: 1px solid #C4C4C4; width:45%;height:300px;">
                                ...
                                <textarea id="q2_text" name="q2_reason" style="height:70%;border: 1px solid #E1E100;box-sizing: border-box;margin:10px 10px 50px 10px; width:95%;background: #F5FFFA;overflow: auto;"></textarea>
                            </div>
                        </article>
                        <article class="style1">
