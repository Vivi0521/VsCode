<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dou6QueryID.aspx.cs" Inherits="ToccWeb.Dou6QueryID" %>
...
<body>
        ...
        <div class="container-login100">
            <div class="wrap-login100 wrap-login200 p-l-85 p-r-85 p-t-55 p-b-55">
                <span class="logo">
                    <img src="Resource/images/logo.png" alt="">
                </span>
                <span class="login100-form-title orange">旅遊史快速通關服務
                </span>
                ...
                <form class="login100-form validate-form flex-sb flex-w">
                    ...
                    <div class="wrap-input100 validate-input input-orange m-b-30" data-validate="請輸入正確資訊">
                    ...
                    <div class="container-login100-form-btn">
                        <input class="login100-form-btn-orange" type="button" value="送出" id="btnSubmit" data-toggle="modal"/>
                    </div>
                </form>
        ...
        function query() {
            ...
            if (checkID(idstr)) {
                $.ajax({
                    ...
                    url: "WebService.asmx/QueryDou6Idno",
                    dataType: "json",
